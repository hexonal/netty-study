...
public abstract class DefaultMaxMessagesRecvByteBufAllocator implements MaxMessagesRecvByteBufAllocator {
    ...
    public abstract class MaxMessageHandle implements ExtendedHandle {
        ...
        public boolean continueReading(UncheckedBooleanSupplier maybeMoreDataSupplier) {
            ...
            boolean  needmore=  (!respectMaybeMoreData || maybeMoreDataSupplier.get());

            boolean  full= totalMessages < maxMessagePerRead ;

           return  autoRead  && needmore &&  full;
...
//                   totalBytesRead > 0;
// MaxMessageHandle  bug：
// totalBytesRead 理论上不能放在这，原因之一：违反了单一职责的原则
// 原因之二，就是个bug
// 服务端接收新连接的使用的场景下，不会 调整    totalBytesRead 值，只会调整  totalMessages
// 结果导致 continueReading 永远是false， 从而导致  批量接收连接 的功能， 无效
        }
